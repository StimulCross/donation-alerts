 ...
 */
export interface DonationAlertsDonationJson {
	id: number;
	name: DonationNameType;
	username: string;
...
export class DonationAlertsDonation extends DataObject<DonationAlertsDonationData, DonationAlertsDonationJson> {
	/**
	 ...
	 */
	public get name(): DonationNameType {
	 ...
	 */
	public get messageType(): DonationMessageType {
	...
	public override toJSON(): DonationAlertsDonationJson {
		return {
			id: this.id,
			name: this.name,
